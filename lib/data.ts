...
export const PRODUCTS: Product[] = [
  {
    ...
    description:
      'Collected at Brahma Muhurtham and at your door before 7:30 AM every morning. Pure, thick and unadulterated — the way milk is supposed to be.',
    price: '₹90',
    unit: 'Litre',
...
export const TIMELINE_STEPS: TimelineStep[] = [
  ...
  },
  {
    time: '5:45 AM',
    title: 'Testing',
    description: 'Rigorous on-farm chemical purity checks on every batch.',
  },
  {
    time: '6:15 AM',
    title: 'Preservation',
    description: 'Stored at safe temperature to maintain purity and natural goodness.',
  },
  {
    time: '6:45 AM',
    title: 'Dispatch',
    description: 'Loaded into sanitised, sealed glass bottle carriers for safe delivery.',
  },
  {
    time: '7:30 AM',
    title: 'Delivered',
    description: 'At your doorstep in a sterilised glass bottle, ready to use.',
  },
]
...
export const FSSAI_NUMBER = '23624031000784' // Replace with actual FSSAI license number
