...
export const TIMELINE_STEPS: TimelineStep[] = [
  {
    ...
    title: "Farm Fresh",
    description:
      "Brahma Muhurtham milking begins under traditional sacred timing.",
  },
  {
    time: "Step 2",
  ...
  },
  {
    ...
    description:
      "Stored at safe temperatures and packed in sanitized glass bottles.",
  },
  {
    time: "Step 4",
    title: "Doorstep Delivery",
    description: "Delivered to your home within 3 Hrs of milking.",
  },
];
...
export const PURITY_FEATURES: PurityFeature[] = [
  {
    ...
    description:
      "Every batch undergoes rigorous quality testing at the farm and again at the doorstep.",
  },
  {
  ...
  },
  {
    ...
    description:
      "Customers have the authority to reject if found adulteration.",
  },
  {
    iconName: "Waves",
...
export const FSSAI_NUMBER =
  process.env.NEXT_PUBLIC_FSSAI_NUMBER || "23624031000784"; // Replace with actual FSSAI license number

export const INSTAGRAM_URL =
  process.env.NEXT_PUBLIC_INSTAGRAM_URL ||
  "https://www.instagram.com/Shuddhnandhavanam";

export const CONTACT_PHONE =
  process.env.NEXT_PUBLIC_CONTACT_PHONE || "+91 99593 06634";

export const CONTACT_EMAIL =
  process.env.NEXT_PUBLIC_CONTACT_EMAIL || "Nandhavanammilk@gmail.com";
